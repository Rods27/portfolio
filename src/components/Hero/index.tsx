...
export default function Hero() {
  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden min-height">
      ...
      />
      <div className="z-20">
        <h2 className="text-sm pb-2 tracking-[15px] uppercase mobileMd:max-w-[470px]">
          {sections.title}
        </h2>
        <h1 className="text-5xl lg:text-6xl font-semibold px-10 mobileMd:text-2xl">
          <span className="mr-3 select-non">{text}</span>
          <Cursor cursorColor={isDayMode ? '#CA8C05' : '#F7AB0A'} />
        </h1>

        <div className="flex justify-center pt-5 gap-2 mobileMd:flex-wrap mobileMd:w-[270px] mobileMd:mx-auto">
          <Link href="#about">
